...
**Vodič:** `docs/FIRESTORE-SPIKE-PLAYBOOK.md` — šta Firebase graf meri (uključujući Worker), kad je **0 read/min** normalno, šta očekivati od `ratings-feed` / `home-bundle` na hladnom kešu, i **šablon zapisa** kad prijaviš pik (vreme, scenario, gost/tabovi, screenshot).
