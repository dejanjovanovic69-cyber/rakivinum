...
**Poslednji zapis:** 2026-04-26 (popodne+) - `Menu` joined-clubs fallback optimizovan: umesto `getDoc` po destileriji koristi batched `where(documentId(), "in", ...)` kada edge vrati `null`.
