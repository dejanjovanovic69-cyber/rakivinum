...
**Poslednji zapis:** 2026-04-26 (popodne++++++++++++++) - `fetchPublicDistilleriesByIds` dodatno kanonizovan (sort ID liste), pa isti skup ID-jeva deli isti dedupe/cache put bez obzira na redosled.
