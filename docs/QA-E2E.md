...
Trenutno smoke pokriva: početnu, Community (default + tab deep linkovi), `/distilleries`, `/collection` (gost prazan ili „Arhiva“), `/menu` (Gost/Korisnik), `/scan`, `/radionica`, `/my-clubs`, `/activate` (bez tokena — forma), `/label/…` (nepostojeći id — poruka o nedostupnosti).
