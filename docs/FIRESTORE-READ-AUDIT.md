...
| Barkod | **`fetchPublicProductByBarcodeLookup`** → `/api/public/product-lookup`, zatim do 3 Firestore upita (uobičajeno 2 jer se preskače dupli `barcode == raw` kad je raw već digits), pa katalog. |
